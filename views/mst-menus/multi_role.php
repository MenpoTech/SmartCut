...
<?= Html::beginForm(['/mst-menus/multi-role'], 'post', ['data-pjax' => '', 'class' => 'form-inline','id'=>'multi-role']); ?>
<?php  echo Html::hiddenInput('submit_btn',0,['id'=>'submit_btn']); ?>

<center class="profile-username text-left">Role Menu Setting</center>
<div id="load_list">
    <table width="100%">
    <tr>
    ...
    <tr>
        ...
        <td width="6%" align="center"><div style="  float:center; vertical-align:middle">
                <input type="button" class="btn btn-danger" value="&gt;&gt;"	onclick="listbox_selectall('s',true);listbox_moveacross('s', 'd');reload_count();" />
                <br />
                <br />
                <input type="button" class = "btn btn-primary center" value="&gt;"	onclick="listbox_moveacross('s', 'd');reload_count();" />
                <br />
                <br />
                <input type="button" class = "btn btn-primary center" value="&lt;"	onclick="listbox_moveacross('d', 's');reload_count();" />
                <br />
                <br />
                <input type="button" class="btn btn-danger" value="&lt;&lt;" onclick="listbox_selectall('d',true);listbox_moveacross('d', 's');reload_count();" />
       ...
       <td width="10%"> <input type="button" class="btn btn-danger" value="Up">
        ...
        <tr><td>&nbsp;</td></tr>
        <tr>
        <td align="right"><a href="<?php echo  \yii\helpers\Url::to(['mst-menus/multi-role']); ?>" class="btn btn-danger"> Reset </a></td>
        <td></td>
