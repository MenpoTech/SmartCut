...
$this->title = 'User Department Mapping';
...
<?= Html::beginForm(Url::to(['mst-user-department-mapping/index']), 'post', ['data-pjax' => '', 'class' => 'form-inline','id'=>'multi-user']); ?>
<?php echo Html::hiddenInput('submit_btn',0,['id'=>'submit_btn']); ?>

<center class="profile-username text-left">User Department Mapping</center>
<div id="load_list">
    <table width="100%">
        <tr>
